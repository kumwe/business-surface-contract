...
final class CustomBusinessPortTest extends TestCase
{
    ...
    public function testTypedViewAndActionInputsPreserveTheirGuards(): void
    {
        ...
        $this->assertSame(50, $query->records->pageSize, 'The canonical query reaches the handler intact.');
    ...
    private function context(): ExecutionContext
    {
        return ExecutionContext::issueSystem(
            new \stdClass(),
            new class implements \Kumwe\Context\Contract\SystemActor {
                public function identifier(): string { return 'system:test'; }
            },
